...
function SOEwr(; β = 0.97, γ = 2, r = 0.02, ϖN = 0.55, η = 1/0.83-1, α = 0.67, wbar = 0.8, ρξ = 0.945, σξ = 0.025, Na = 40, Nξ = 21, amin = -1, amax = 4)
	...
	return SOEwr(pars, agrid, zgrid, ξgrid, Pξ, v, gc, ga, pN, w, Ap, Y)
end
