...
function SOEwr_cc(; β = 0.97, γ = 2, r = 0.02, ϖN = 0.55, η = 1/0.83-1, α = 0.67, wbar = 0.8, ρz = 0.945, σz = 0.025, Na = 40, Nz = 21, amin = -1, amax = 4)
	...
	return SOEwr_cc(pars, agrid, zgrid, Pz, v, gc, ga, pN, w, Ap, Y, ξchain, ξgrid)
end
...
function diff_pN(pNv, pcC, zv, sw::SOE)
	...
	Voy a ir subiendo los códigos de los modelos y las slides de las clases. Podés encontrar el syllabus del curso.
	Code Camp
		...
		Code Camp
			...
			Code Camp
				...
				Clase 0: video
				Clase 1: video, códigos
				Clase 2: video, códigos
			
			Clases
			
				Clase 1: Slides. Códigos para sacar uniformes hasta sumar 1 stats_1.jl y el modelo de búsqueda de McCall: mccall.jl.
				Práctica 1: Slides de la clase. Slides de Alfredo sobre Neumeyer-Perri. También la primera guía de ejercicios (a entregar el 29 de septiembre) y códigos para el problema de la torta cakeeating.jl y itpcake.jl
				Clase 2: Slides de la clase. Slides de Francisco sobre Aguiar-Gopinath.
				Práctica 2: Slides de la clase. También la primera y la segunda mitad de la segunda guía de ejercicios (acá todo junto, a entre
			Clase 1: video, códigos
			Clase 2: video, códigos
	...
	Clases
		...
		Práctica 1: Slides de la clase. Slides de Alfredo sobre Neumeyer-Perri. También la primera guía de ejercicios (a entregar el 29 de septiembre) y códigos para el problema de la torta cakeeating.jl y itpcake.jl
		Clase 2: Slides de la clase. Slides de Francisco sobre Aguiar-Gopinath.
		Práctica 2: Slides de la clase. También la primera y la segunda mitad de la segunda guía de ejercicios (acá todo junto, a entre find_w(zv, cT, wbar, sw)
